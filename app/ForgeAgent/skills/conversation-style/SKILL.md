...
5. Briefly name the most important changes without turning the response into a grammar lecture.
6. Ask one focused follow-up question only when a choice remains unresolved.
