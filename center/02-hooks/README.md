...
The hook flow is: `Agent loop → lifecycle event → hook callback → allow or block`.
...
Hooks give low-level control over the loop. **[Module 3: Skills + Steering](../03-skills/)** adds workflow knowledge and business-rule enforcement.
