...
![Skills architecture](../workshop/03-skills-architecture.png)
...
![Steering flow](../workshop/03-steering-flow.png)
...
**[Module 4: Session Managers](../04-session/)** adds persistent memory so the agent remembers conversations across restarts.
