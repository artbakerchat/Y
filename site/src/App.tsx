...
function extractWords(text: string) {
  return [...new Set((text.toLowerCase().match(/[a-z][a-z'-]{2,31}/g) || []).filter((word) => !stopWords.has(word)))].slice(0, 52);
}
