        ...
        {messages.length ? (
          messages.map((message, index) => (
            <div className={`message ${message.role}`} key={`${index}-${message.content}`}>
              <div className="avatar" aria-label={message.role === 'user' ? 'You' : 'Larboard'} title={message.role === 'user' ? 'You' : 'Larboard'}>{message.role === 'user' ? 'You' : 'Larboard'}</div>
          ...
          <>
            <div className="message">
              <div className="avatar" aria-label="Larboard" title="Larboard">Larboard</div>
